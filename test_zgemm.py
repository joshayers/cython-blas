...
def main() -> None:  # noqa: PLR0915
    ...
    lda, ldb, ldc = mat_a.strides[1] // 16, mat_b.strides[1] // 16, mat_c.strides[1] // 16
    ...
    m, n, k = mat_a.shape[0], mat_b.shape[1], mat_a.shape[1]
    lda, ldb, ldc = mat_a.strides[0] // 16, mat_b.strides[1] // 16, mat_c.strides[1] // 16
    ...
    m, n, k = mat_a.shape[0], mat_b.shape[1], mat_a.shape[1]
    lda, ldb, ldc = mat_a.strides[1] // 16, mat_b.strides[0] // 16, mat_c.strides[1] // 16
    assert lda == m  # noqa: S101
    ...
    m, n, k = mat_a.shape[0], mat_b.shape[1], mat_a.shape[1]
    lda, ldb, ldc = mat_a.strides[0] // 16, mat_b.strides[0] // 16, mat_c.strides[1] // 16
    assert lda == k  # noqa: S101
    assert ldb == n  # noqa: S101
    assert ldc == m  # noqa: S101
    mat_c_orig = mat_c.copy()
